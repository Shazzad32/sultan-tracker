...
const OrderPage = () => {
  ...
  //       });
  //     } else {
  //       alert("❌ অর্ডার পাঠানো যায়নি। দয়া করে আবার চেষ্টা করুন।");
  //     }
  //   } catch (err) {
  //     console.error(err);
    ...
    >
      <div className="w-full max-w-6xl bg-white rounded-xl p-6 shadow-md">
        <h1 className="text-xl md:text-2xl text-center font-bold text-red-600 mb-2">
          গাড়ির নিরাপত্তা নিয়ে একটুও ছাড় নয়, আগে থেকেই সাবধান থাকুন।
        </h1>
        <p className="text-center mb-6 text-black font-semibold">
